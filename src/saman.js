...
function arrayEquality(a1, a2) {
    ...
    let isEqual = false;
    for (let i in a1) isEqual = equal(a1[i], a2[i]);
    return isEqual;
}
...
function objectEquality(o1, o2) {
    ...
    let isEqual = false;
    for (let p1 in f1) for (let p2 in f2) isEqual = p1 == p2 && equal(o1[p1], o2[p2]);
    return isEqual;
}
...
function merge(obj1, obj2) {
    let m = Object.assign({}, obj1, obj2);
    for (let p1 in obj1) for (let p2 in obj2)
        p1 == p2 &&
